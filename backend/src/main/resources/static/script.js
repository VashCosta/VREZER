...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function runAnalysis() {
        ...
        try {
            ...
            const anRes = await fetch('/api/analyzer/analyze', { method: 'POST', headers: { 'Content-Type': 'text/plain' }, body: exJson.text });
            ...
            if (data.error) {
                ...
                // Removed auto-reload to allow user to retry manually or fix their resume
                return;
            }
